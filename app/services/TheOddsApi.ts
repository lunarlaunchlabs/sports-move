...
const API_KEY_5_MILLION_PER_MONTH = '90c8987732fc1f15372c6852892af9de';
...
export class TheOddsApi {
  ...
  static async getMarkets(sport: SPORT_MARKET_KEY): Promise<MarketData[]> {
    const url = `${BASE_URL}/${sport}/odds?regions=us&oddsFormat=american&apiKey=${API_KEY_5_MILLION_PER_MONTH}`;
  ...
  static async getScores(sport: SPORT_MARKET_KEY): Promise<ScoreData[]> {
    const url = `${BASE_URL}/${sport}/scores/?daysFrom=1&apiKey=${API_KEY_5_MILLION_PER_MONTH}`;
